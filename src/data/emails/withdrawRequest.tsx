export default function withdrawRequestHTML(
  ...
  <table border="0" cellpadding="0" cellspacing="0" align="center"
    ...
    <tr>
      <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
        ...
        ${user} has requested to withdraw ${amount} DFK from their account. Please review the request and approve or deny it within ${deadlineInDays} days.
      </td>
    </tr>
  ...
  This email was sent to you because of activity on a PocketMate account. If you did not expect this, please ignore this email.
